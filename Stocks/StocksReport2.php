        ...
        <table>
          ...
          <tbody>
            <?php
                ...
                $rows = $query->find_all();  
                foreach($rows as $current_rows)
                {
                    $rank = $current_rows->get_rank();
                    $symbol = $current_rows->get_symbol();
                    $company = $current_rows->get_company();
                    $quant = $current_rows->get_quant();
                    $saAuthors = $current_rows->get_saAuthors();                
                    $wallStreet = $current_rows->get_wallStreet();
                    $marketCap = $current_rows->get_marketCap();
                    $trclass = "";
